...
const notifications = {
  ...
  message: {
    ...
    unlock_by_cookie_address: 'dCipher has switched your account to the watch-only mode, and your private-key is no longer available to the browser.  You\'ll need to unlock your wallet again to perform some operations.',
...
export default {
  ...
  place_order_by_loopr: {
    ...
    instruction_download: 'Download dCipher-IOS',
  ...
  unlock_by_loopr: {
    instruction_download: 'Download dCipher-IOS',
    instruction_scan: 'Open your dCipher wallet，scan the QRcode and confirm',
